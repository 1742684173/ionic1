...
//zxl新增 登录统计
-(void)loginTotal:(CDVInvokedUrlCommand*)command{
    ...
    NSLog(@"登录统计--->方法：%@",loginMethod);
    NSLog(@"登录统计--->是否成功：%@",loginSuccess?@"YES":@"NO");
    ...
    CDVPluginResult VPluginResult* pluginResult = [CDVPluginResult resultWithStatus:CDVCommandStatus_OK messageAsString:@"login total success"];
    [self.commandDelegate sendPluginResult:pluginResult callbackId:command.callbackId];
}

//zxl新增 注册统计
-(void)registerTotal:(CDVInvokedUrlCommand*)command{
