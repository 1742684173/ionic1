...
//zxl 新增登录与注册统计
//登录统计
JPushPlugin.prototype.loginTotal = function(loginMethod, loginSuccess, extMap, successCallback, errorCallback) {
	loginMethod = loginMethod || "";
	loginSuccess = !!loginSuccess;
	extMap = extMap || {};
	this.callNative('loginTotal', [loginMethod, loginSuccess, extMap], function(msg) {
		console.log(msg);
	}, function(msg) {
		console.log(msg);
	});
...
//注册统计
JPushPlugin.prototype.registerTotal = function(registerMethod, registerSuccess, extMap, successCallback, errorCallback) {
	registerMethod = registerMethod || "";
	registerSuccess = !!registerSuccess;
	extMap = extMap || {};
	this.callNative('registerTotal', [registerMethod, registerSuccess, extMap], function(msg) {
		console.log(msg);
	}, function(msg) {
		console.log(msg);
	});
...
JPushPlugin.prototype.addLocalNotification = function(builderId, content, title,
	...
	if(device.platform === 'Android') {
		this.callNative('addLocalNotification', [builderId, content, title, notificationID, broadcastTime, extras], null)
	}
}
